<x-app-layout>
    <section class="section container">
        ...
        <h1 class="title has-text-grey mt-6 pb-6 px-1">kapkara mühendislik danışmanlık</h1>
