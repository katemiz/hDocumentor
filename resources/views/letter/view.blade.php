    ...
    <section class="section container" >
        ...
        <div class="column has-text-right">
            ...
            @else
                ...
                <a onclick="confirmDelete('{{$letter->id}}','letter')">
                    <span class="icon is-small">
                        <x-heroicon-s-trash class="has-text-danger"/>
                    </span>
                </a>

                <a onclick="signConfirm('{{$letter->id}}')">
                    <span class="icon is-small">
                        <x-heroicon-s-shield-check class="has-text-primary"/>
                    </span>
                </a>
            ...
            <a href="/letter-pdf/{{$letter->id}}" class="ml-4">
                <span class="icon is-small">
